...
import { createYerelAsistanTool } from "../tools/yerel-asistan"
import { createPersonalosTools } from "../tools/personalos-memory"
import { createOmegaTools } from "../tools/omega"
...
export function createToolRegistry(args: {
  ...
  const allTools: Record<string, ToolDefinition> = {
    ...
    ...taskToolsRecord,
    ...hashlineToolsRecord,
    ...createYerelAsistanTool(),
    // PersonalOS Tools
    ...createPersonalosTools(ctx),
    // OMEGA Tools
    ...createOmegaTools(ctx),
  }
